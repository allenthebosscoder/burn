...
pub struct ShuffledDataset<D, I, L: Label>
where
    D: Dataset<I, L>,
    I: Clone + Send + Sync,
{
    wrapped: SelectionDataset<D, I, L>,
}

impl<D, I, L: Label> ShuffledDataset<D, I, L>
where
    D: Dataset<I, L>,
    I: Clone + Send + Sync,
{
...
impl<D, I, L: Label> Dataset<I, L> for ShuffledDataset<D, I, L>
where
    D: Dataset<I, L>,
    I: Clone + Send + Sync,
{
