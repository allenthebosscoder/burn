...
#[derive(new, Clone)]
pub struct PartialDataset<D, I, L: Label> {
    dataset: D,
    start_index: usize,
    end_index: usize,
...
impl<D, I, L: Label> PartialDataset<D, I, L>
where
    D: Dataset<I, L>,
{
    /// Splits a dataset into multiple partial datasets.
    pub fn split(dataset: D, num: usize) -> Vec<PartialDataset<Arc<D>, I, L>> {
...
impl<D, I, L: Label> Dataset<I, L> for PartialDataset<D, I, L>
where
    D: Dataset<I, L>,
    I: Clone + Send + Sync,
{
